...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/landeanv/permission/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/landeanv/permission/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/landeanv/permission/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/landeanv/permission/main/ip | grep $MYIP | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/landeanv/permission/main/ip | grep $MYIP | awk '{print $3}')
...
wget raw.githubusercontent.com/landeanv/v3/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
...
wget -q -O udp-mini-1.service "${REPO}limit/udp-mini-1.service"
wget -q -O udp-mini-2.service "${REPO}limit/udp-mini-2.service"
wget -q -O udp-mini-3.service "${REPO}limit/udp-mini-3.service"
